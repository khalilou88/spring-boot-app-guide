...
class UserValidationIntegrationTest extends AbstractIntegrationTest {
    ...
    void shouldRejectInvalidEmailFormat() {
        ...
        // When
        ResponseEntity<ValidationErrorDetails> response = restTemplate
                .postForEntity(USER_API_PATH, userCreationDTO, ValidationErrorDetails.class);
...
//                .anyMatch(error -> error.contains("strength") || error.contains("requirements"));
    ...
    void shouldAcceptValidUserData() {
        ...
        ResponseEntity<Object> response = restTemplate
                .postForEntity(USER_API_PATH, userCreationDTO, Object.class);
    ...
    void shouldRejectDuplicateEmail() {
        // First create a user
        UserCreationDTO firstUser = UserCreationDTO.builder()
        ...
        UserCreationDTO secondUser = UserCreationDTO.builder()
                .email("duplicate@example.com")
                .username("seconduser")
                .password("ValidPassword123!")
                .firstName("Second")
        ...
        // When
        ResponseEntity<ValidationErrorDetails> response = restTemplate
                .postForEntity(USER_API_PATH, secondUser, ValidationErrorDetails.class);
